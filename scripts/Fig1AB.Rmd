...
Fig S1A - PCA of mouse vendor from 16S data
```{r , echo=FALSE}
...
Fig 1B - Shannon Diversity of 16S seqs
```{r}
#library(entropart)
library(vegan)
set.seed(123)
...
Supplementary Figure 1B: 16S barplots for different vendors or relative amounts
