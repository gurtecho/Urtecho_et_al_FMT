...
conda install -c conda-forge -c bioconda ultraplex seqkit vsearch pandas
...
foo () {
    ...
    usearch10 -fastq_filter "${FILENAME}" -fastq_maxee 1.0 -fastq_minlen 150 -relabel @ -fastqout "${OUTFILE}" -threads $THREADS
}
