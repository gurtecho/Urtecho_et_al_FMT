...
foo () {
    ...
    ./bin/usearch10 -fastq_filter "${FILENAME}" -fastq_maxee 1.0 -fastq_minlen 150 -relabel @ -fastqout "${OUTFILE}" -threads $THREADS
}
...
./bin/usearch10 -fastq_filter otu/final_filt_all_particleid.fastq -fastq_maxee 0.1 -relabel @ -fastqout otu/filt_all_double.fq -threads $THREADS
